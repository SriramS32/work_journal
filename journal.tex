...
\subsection{September 28, 2017}
\subparagraph{Work}
Team was thinking about cycle-GAN as a baseline between audio styles (e.g. angry and calm speech). Also, going to real quick play around with normal VAE.

\subsection{October 20, 2017}
\subparagraph{Ideas}
Make sure you think of a reversable input processing algo to either process 2 channel post-stft signal or something else, to make the filter size convolve over something meaningful.
